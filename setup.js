 ...
 * ══════════════════════════════════════════════════════
 * حفظ بيانات القافلة وعرضها، لوحة المدير الإحصائية
 *
...
// ══════════════════════════════════════════════════════
// إزاي تستخدم setup.js
// ══════════════════════════════════════════════════════
// - applySessUI()    → حدّث بيانات القافلة في الشريط العلوي
// - buildDashboard() → ارسم لوحة المدير (البطاقات الكبيرة)
//
// ملاحظة: saveSetup() موجودة في auth.js (تبعة دور المدير)
// ══════════════════════════════════════════════════════
...
// ── Splash Screen — IIFE بيشتغل فوراً بدون window.load ──────────────
(function(){
  setTimeout(function(){
