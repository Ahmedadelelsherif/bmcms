 ...
 * ══════════════════════════════════════════════════════
 * ملخص الأيام، تحاليل الدم، ضغط الدم، السكر، الحالات الغير طبيعية
 *
...
// ══════════════════════════════════════════════════════
// إزاي تستخدم stats.js
// ══════════════════════════════════════════════════════
// - buildStats()              → التقرير الرئيسي الكامل
// - buildBloodStats(arr)      → إحصائيات معمل الدم
//   ┌─────────────────────────────────────────────────┐
//   │ التحليل │ يوم١ طبيعي │ يوم١ غير طبيعي │ الكل │
//   └─────────────────────────────────────────────────┘
// - buildScreenStats(arr)     → إحصائيات افحص واطمن
//   ┌──────────────────────────────────────────────────┐
//   │ نطاقات الضغط: منخفض/طبيعي/حدودي/مرتفع1/مرتفع2 │
//   │ نطاقات السكر: منخفض/طبيعي/حدودي/مرتفع          │
//   │ كل نطاق: يوم١(ذكور/إناث) + يوم٢ + الإجمالي     │
//   └──────────────────────────────────────────────────┘
// - buildAbnormalReport(arr)  → بيان تفصيلي بالحالات الغير طبيعية
// - buildDashboard()          → في setup.js (البطاقات الكبيرة)
//
// ⚠️ لو أضفت فحص جديد في forms.js: أضفه في buildBloodStats
// ══════════════════════════════════════════════════════
