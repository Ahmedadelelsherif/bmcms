 ...
 * ══════════════════════════════════════════════════════
 * Excel للأقسام، تقرير الواتساب، تصدير الحالات الغير طبيعية
 *
 * يعتمد على: config.js, state.js, records.js (SheetJS CDN مطلوب)
 * ══════════════════════════════════════════════════════
 */

// ══════════════════════════════════════════════════════
// إزاي تستخدم export.js
// ══════════════════════════════════════════════════════
// - exportExcel()           → ملف Excel كامل (4 شيتات)
// - exportDeptExcel('blood')→ Excel لقسم واحد فقط
// - exportAbnormalExcel()   → Excel للحالات الغير طبيعية
// - sendWhatsAppReport()    → إرسال تقرير واتساب لـ 01212021490
//
// ⚠️ متطلبات:
// - SheetJS CDN محتاج يتحمّل (موجود في index.html)
// - لو أضفت حقل جديد في forms.js: ضيفه في addDeptSheet
//
// شيتات Excel الموجودة:
// 1. معمل_الدم   - كل التحاليل مع النتائج
// 2. الطفيليات   - فحوصات البول والبراز
// 3. الأشعة      - الفحوصات الإشعاعية
// 4. افحص_واطمن  - الضغط والسكر وHbA1c
// ══════════════════════════════════════════════════════
